...
- **[Feather](https://github.com/feather-wallet/feather)** - is a free, open-source Monero wallet for Linux, Tails, macOS and Windows. It is written in C++ with the Qt framework.
